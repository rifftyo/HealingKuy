...
import com.rifftyo.healingkuy.databinding.FragmentFirstSplashBinding
...
class FirstSplashFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imgStatusFirst.setColorFilter(ContextCompat.getColor(requireContext(), R.color.blue_splash))
    }
