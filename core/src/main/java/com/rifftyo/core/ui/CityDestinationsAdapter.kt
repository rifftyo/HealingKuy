...
import com.rifftyo.core.databinding.ItemCityDestinationsBinding
import com.rifftyo.core.domain.model.Destinations

class CityDestinationsAdapter : ListAdapter<Destinations, CityDestinationsAdapter.ListViewHolder>(DIFF_CALLBACK) {

    var onItemClick: ((Destinations) -> Unit)? = null

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder =
        ListViewHolder(
            ItemCityDestinationsBinding.inflate(
    ...
    inner class ListViewHolder(private val binding: ItemCityDestinationsBinding) :
